...
func TestIfExpression(t *testing.T){
	...
	if !ok {
		t.Fatalf("stmt.Expressioin is not ast.IfExpression. got=%T",stmt.Expression)
	}
	...
	if len(exp.Consequence.Statements) != 1 {
		t.Errorf("len(exp.Consequence.Statements) not equal to %d. got=%d",1,len(exp.Consequence.Statements))
	}
